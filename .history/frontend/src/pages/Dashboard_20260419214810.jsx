// temporary fake stats so we can see the UI
const MOCK_STATS = {
  total: 24,
  applied: 11,
  interview: 6,
  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        ...
        >
          <h3 style={{ fontWeight: 500, fontSize: 14, marginBottom: 16 }}>
            Smart insights
          </h3>
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {[
              ...
              {
                label: "Response rate",
                value: `${stats.response_rate}% of applications got a reply`,
              },
              {
                label: "Follow-up needed",
                value: `${stats.follow_up_due} applications with no reply in 10+ days`,
              },
              {
                label: "Offer rate",
                value: `${stats.offer_rate}% of applications resulted in an offer`,
              },
            ].map(({ label, value }) => (
              <div
                key={label}
              ...
              >
                <div
                  style={{ fontSize: 11, color: "#9d9d99", marginBottom: 3 }}
                >
                  {label}
                </div>
